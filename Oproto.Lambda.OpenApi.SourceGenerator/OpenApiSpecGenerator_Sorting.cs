...
public partial class OpenApiSpecGenerator
{
    ...
    /// </summary>
    private static IDictionary<string, OpenApiSchema> SortSchemas(IDictionary<string, OpenApiSchema> schemas)
    {
    ...
    /// </summary>
    private static IList<OpenApiTag> SortTags(IList<OpenApiTag> tags)
    {
    ...
    /// </summary>
    private static IDictionary<string, OpenApiSecurityScheme> SortSecuritySchemes(
    ...
    /// </summary>
    private static IDictionary<OperationType, OpenApiOperation> SortOperations(
    ...
    /// </summary>
    private static IDictionary<string, OpenApiExample> SortExamples(IDictionary<string, OpenApiExample> examples)
    {
